...
ax1.set_title(f"Linear minimization contour plot of {function_latex}")

line, = ax1.plot([], [], 'r', label = 'Linear minimization', lw = 1.5)
...
ax2.set_title(f"Linear minimization surface plot of {function_latex}")

ax2.view_init(40, 165)

line, = ax2.plot([], [], [], 'r', label = 'Linear minimization', lw = 1.5)
